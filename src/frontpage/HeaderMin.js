    ...
    return (
      <div id="head" className="myheader header-min header-small ab">
        {this.props.page.isRestaurant ? (
          <Link to={receiptpath}>
            <img src={ajx.logo} id="logo-min" alt="logo" className="zzq" />
          </Link>
        ) : (
          <Link className="Mybukkalogo" to="/">
            <img src={ajx.logo} id="logo-min" alt="logo" />
          </Link>
        )}
        {this.props.page.isRestaurant || this.props.other ? null : (
        ...
        {!this.props.user.isAuthenticated ? (
          <div className=" header-top-button header-top-button-min small-head ">
            ...
            <button
              className="btn-red display-toggle min-sign-up"
          ...
          <div className=" m-info small-head">
            <div className="m-profile-photo-holder hh">
              <div className="m-user-icon-holder display-toggle">
                <img
                  src={this.props.user.user.profile_photo}
                  alt=" "
                  className="m-profile-photo"
                />
              </div>
              <div className="m-profile-options display-toggle">
                <Link to="/profile" className="lin m-options">
                  Account
                </Link>
                <a className="m-options" onClick={lib.signout}>
                  Log Out
                </a>
              </div>
            </div>
            {this.props.chef.fetched ? (
              <div>
                ...
                <div
                  className="m-cart-not-signed-in display-toggle em lk"
                  id="l"
                >
                  <MdShoppingCart className="shopping-cart display-toggle" />
                  <div className="m-cart-items">
