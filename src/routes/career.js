            ...
            <div className="row">
              <div className="col-md-6 left">
                <label>
                  ...
                  <input className="inp in" type="text" name="name" id="name" />
                </label>
                ...
                <div className="p">
                  <label>
                    <div>
                      Professional experience:<span className="sp-required">
                        *
                      </span>
                    </div>
                    <div className="year">
                      ...
                      <input
                        ...
                        id="year"
                        type="number"
                        name="professional-experience-year"
                      />
                    </div>
                    <div className="month">
                      <p>Month</p>
                      <input
                        ...
                        id="month"
                        type="number"
                        name="professional-experience-month"
                      />
                    </div>
                  </label>
                </div>
              ...
              <div className="col-md-6 right">
                ...
                <label>
                  <div>
                    Team you want to part of:<span className="sp-required">
                      *
                    </span>
                  </div>
                ...
                <label>
                  ...
                  <input
                    ...
                    placeholder="http://"
                  />
                  (Twitter, Blog, LinkedIn or anything that you would like us to
                  make a note of!)
                </label>
                <label>
                ...
                <label>
                  <div>
                    Submit the link to your resume:<span className="sp-required">
                      *
                    </span>
                  </div>
                  <input
